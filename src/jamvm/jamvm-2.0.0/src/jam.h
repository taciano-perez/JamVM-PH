...
extern int initialiseClassStage2(InitArgs *args);
...
extern int initialiseString(InitArgs *args);
...
extern int initialiseUtf8(InitArgs *args);
...
extern int initialiseMonitor(InitArgs *args);
