...
// JaPHa Modification
// Changed function to persistent call
    ...
    for(i = 1; i < cp_count; i++) {
        ...
        switch(tag) {
           ...
           case CONSTANT_Utf8:
           {
               ...
               buff = sysMalloc_persistent(length + 1);
...
void linkClass(Class *class) {
   ...
   cb->imethod_table = sysMalloc_persistent( (spr_imthd_tbl_sze + new_itable_count) * sizeof(ITableEntry) );
...
int initialiseClassStage2(InitArgs *args) {
