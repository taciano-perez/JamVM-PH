...
#define initHashTable(table, initial_size, create_lock, ht_name, create_file)                \
{                                                                      \
    table.hash_table = (HashEntry*)gcMemMalloc(sizeof(HashEntry)*initial_size, ht_name, create_file);    \
